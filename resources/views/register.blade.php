...
<head>
    ...
    <title>Đăng Ký Tài Khoản | AI CỦA TÔI - Dịch Vụ Tài Khoản Giá Rẻ</title>
    <meta name="description" content="Đăng ký tài khoản AI CỦA TÔI để được nâng cấp tài khoản CapCut Pro, ChatGPT, Canva Pro chính chủ nhanh nhất.">
        ...
        * {
        ...
        body {
            ...
            background-image: 
                ...
                radial-gradient(circle at 90% 80%, rgba(14, 165, 233, 0.05) 0%, transparent 455%);
        }
...
<body>
    ...
    <div class="auth-container">
        ...
        <p class="auth-subtitle">Tạo tài khoản mới để bắt đầu trải nghiệm dịch vụ</p>
        ...
        <form action="/register" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="text" name="name" id="name" class="form-input" placeholder="Nguyễn Văn A" value="{{ old('name') }}" required>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-wrapper">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="form-input" placeholder="Nhập lại mật khẩu" required>
                </div>
            </div>
