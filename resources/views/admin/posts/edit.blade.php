        ...
        <div class="modal-card">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="form-help">Hãy mô tả chi tiết ý tưởng của bạn để AI có thể viết bài viết chất lượng và đúng trọng tâm nhất. Dữ liệu mới sẽ ghi đè lên các ô nhập liệu hiện tại.</div>
                </div>
    ...
    <script>
        ...
        function generateArticleWithAi() {
            ...
            .then(result => {
                ...
                alert('AI đã viết lại bài viết thành công! Hãy kiểm tra lại, thêm ảnh đại diện và nhấn "Lưu Thay Đổi".');
            })
            .catch(error => {
